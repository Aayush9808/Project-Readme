...
- 🖥️ **On screen (do this):** what you should open/click
...
🖥️ **On screen (do this):** Homepage hero section (GigArmor title + tagline visible).
...
🖥️ **On screen (do this):** Scroll slightly to coverage cards (show 2–3 cards quickly).
...
🖥️ **On screen (do this):** Scroll to pricing calculator and move slider once.
...
🖥️ **On screen (do this):** Keep Market Crash page open on final frame.
...
🖥️ **On screen (do this):** Homepage top section.
...
🖥️ **On screen (do this):** Coverage section (show loss-of-income categories).
...
🖥️ **On screen (do this):** Pricing calculator (change zone/type/days once).
...
🖥️ **On screen (do this):** Market Crash + sidebar visible, end recording.
